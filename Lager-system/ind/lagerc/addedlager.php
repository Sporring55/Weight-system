...
if(isset($_POST["submit"])){
    ...
    if(empty($data_miss)){
        ...
        if($stmt = mysqli_prepare($dbc, "INSERT INTO lagerc (kara, batch, modt, udløb, ny, lokale, vægt, produk) VALUES (?,?,?,?,?,?,?,?)")){
...
?>
<form action="http://localhost:8888/Git-hub/Lager-system/ind/lagerC/addedlager.php" method="post">
<h2 id="over"><b>Skriv ind her</b></h2>
<p id="over"><b>Produktnavn:</b><br />
<input type="text" name="produk" size="30" value=""/>
</p>
<p id="over"><b>Batch Nr:</b><br />
<input type="text" name="batch" size="30" value=""/>
</p>
<p id="over"><b>Vægt i KG:</b><br />
<input type="text" name="vægt" size="30" value=""/>
</p>
<p id="over"><b>Lokation:</b><br />
<input type="text" name="lokale" style='text-transform:uppercase' size="30" value=""/>
</p>
<p id="over"><b>Modt. dato:</b><br />
<input type="text" name="modt" size="30" value=""/>
</p>
<p id="over"><b>Udløbs dato:</b><br />
<input type="text" name="udløb" size="30" value=""/>
</p>
...
<a id="btn" href="http://localhost:8888/LagerABC/Logout.html?logout=1"><button>Logout</button></a>
</body>
</html>