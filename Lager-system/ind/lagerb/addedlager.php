...
if(isset($_POST["submit"])){
    ...
    if(empty($data_miss)){
        ...
        if($stmt = mysqli_prepare($dbc, "INSERT INTO lagerb (kara, batch, modt, udløb, ny, lokale, vægt, produk) VALUES (?,?,?,?,?,?,?,?)")){
...
?>
<form action="http://localhost:8888/Git-hub/Lager-system/ind/lagerb/addedlager.php" method="post">
...
<input type="text" style="text-transform:uppercase" name="lokale" size="30" value=""/>
</p>
