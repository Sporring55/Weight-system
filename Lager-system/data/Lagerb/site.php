...
<body>
    ...
    <input type="text" id="search" size="30" placeholder="Søg produkt">
        <form align="center" method="post" action="http://localhost:8888/Git-hub/Lager-system/data/Lagerb/site.php">
        ...
        <input id=næst type="number" name="b_id" size="10" />
        </p>
       ...
       <?php
        ...
        if(isset($_POST["submit"])){ //Update til næste produkt
            $vægt = $_POST["vægt"];
            $id = $_POST["b_id"];
            $query1 = "UPDATE lagerb SET vægt = '$vægt' WHERE b_id = '$id'";
